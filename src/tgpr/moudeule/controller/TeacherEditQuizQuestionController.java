...
public class TeacherEditQuizQuestionController extends Controller {
    ...
    public void run() {
        ...
        try {
            ...
            do {
                ...
                if (res.equals("1")) {
                    editTitle(view, question);
                } else if (res.equals("2")) {
                    editType(view, question);
                } else if (res.equals("0")) {
                    addOption(view, question, options);
                } else if (isParsable(res) && Integer.parseInt(res) >= 3 && Integer.parseInt(res) < 3 + options.size()) {
                    editOption(view, question, options, res);
    ...
    public void editTitle(TeacherEditQuizQuestionView view, Question question) {
        String title = view.askForTitle(question.getTitle());
        question.setTitle(title);
        question.save();
    }

    public void editType(TeacherEditQuizQuestionView view, Question question) {
    ...
    public void addOption(TeacherEditQuizQuestionView view, Question question, List<Option> options) {
        try {
    ...
    public void editOption(TeacherEditQuizQuestionView view, Question question, List<Option> options, String res) {
        try {
